...
public class server {
    ...
    public void initListNode() {
        try {
        	node n = new node(3000,"10.252.4.154",0, false);
            node n1 = new node(3004,"10.252.4.156",4, false);
            node n2 = new node(3005,"10.252.4.149",5, false);
            node n3 = new node(3006,"10.252.4.152",6,false);
...
//--- text panel settext
    ...
    public void WriteLog(String filename) throws IOException {
        ...
        try {
            PrintWriter pw = new PrintWriter(new FileWriter("D:\\htpt_moi\\cac-he-thong-phan-tan-bully-algorithm\\src\\main\\java\\log\\" + filename, true));
